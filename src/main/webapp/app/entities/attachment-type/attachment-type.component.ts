...
export class AttachmentTypeComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.attachmentTypeService
      ...
      .subscribe(
        (res: HttpResponse<IAttachmentType[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  protected onSuccess(data: IAttachmentType[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
